...
{
    public class UpdateUserProfilePortfolioValidator : AbstractValidator<UpdateUserProfilePortfolioDTO>
    {
        public UpdateUserProfilePortfolioValidator(UpWorkContext context)
        {
